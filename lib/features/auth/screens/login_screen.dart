            ...
            children: [
              ...
              Container(
                ...
                constraints: BoxConstraints(
                  minHeight: size.height - 200 - MediaQuery.of(context).padding.top,
                ),
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: const LinearGradient(
                          colors: [
                            ...
                            Color(0xFFFF8F00), // Darker/Orange Amber (Bottom-Right)
                          ],
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: const Color(0xFFFFB300).withValues(alpha: 0.4), // Transparent amber shadow
                            blurRadius: 15, // Wide blur for a soft light effect
                            offset: const Offset(0, 5), // Slightly shifted downwards
                          ),
                        ],
                      ),
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 18, 
                                      fontWeight: FontWeight.bold,
                                      color: Colors.white, // Contrast with the gradient
